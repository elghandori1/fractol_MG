...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/27 12:41:12 by moel-gha          #+#    #+#             */
/*   Updated: 2024/03/27 12:41:17 by moel-gha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_error(void)
{
	...
	write(1, "for bonus we use the burning with specific number(3)\n", 54);
	exit(1);
}
...
int	pars_params(int ac, char **arg)
{
	...
	if (lenght != 1 || (arg[1][0] < '1' || arg[1][0] > '3'))
		return (1);
	else if (arg[1][0] == '2')
	{
		if (ac != 4)
